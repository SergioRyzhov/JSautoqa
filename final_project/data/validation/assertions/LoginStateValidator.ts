...
export class StateValidator {
  ...
  async assertLoggedOut() {
    await this.assertPageState(
      logoutPage.loginHeader,
      textData.logoutPage.header,
      pageEndpoints.loginPage
    );
  }

  async assertLoginSuccess() {
    await this.assertPageState(
      loginPage.accountTitle,
      textData.loginPage.header,
      pageEndpoints.accountPage
    );
  }
